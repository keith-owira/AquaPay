...
if (isset($_POST['addBill'])){
  addBill($_POST['accno'],$_POST['bill'],$_POST['datefrom'],$_POST['dateto'],$connect);
}
if (isset($_GET['fetch_bill'])){
  fetch_bill($connect);
}
if (isset($_POST['updateaction'])){
  editbill($_POST['user_id'],$_POST['accno'],$_POST['bill'],$_POST['datefrom'],$_POST['dateto'],$connect);
}
if (isset($_POST['editaction'])){
  fetch_single($_POST['user_id'],$connect);
}
if (isset($_POST['deleteaction'])){
  deleteBill($_POST['user_id'],$connect);
}

if (isset($_POST['addcard'])){
   if(!isset($_SESSION)) {session_start();}
  addcredit($_SESSION['userid'],$_POST['name'],$_POST['date'],$_POST['cardnumber'] ,$connect);
}
if (isset($_POST['deleteacard'])){
  deleteCard($_POST['user_id'],$connect);
}
?>  
