    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        ...
        <div class="container px-4 py-5 mx-auto">
            <div class="card card0">
                ...
                echo"</pre>";
                  ...
                  <div class="row gx-4 gx-lg-5">
                        <div class="col-lg-3 col-md-6 text-center">
                            <div class="mt-5">
                                <div class="mb-2"><a href="payment.php"><i class="bi bi-receipt-cutoff fs-1 text-primary"></i></a></div>
                ...
                <div class="mt-5">
                     <div class="mb-2"><i class="bi bi-credit-card" style="text-decoration-color: black;font-size: 32px; padding-left: 20px;"> Payment Info<?php
                    echo"<pre>";
